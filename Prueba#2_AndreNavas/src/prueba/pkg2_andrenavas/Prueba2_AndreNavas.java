...
public class Prueba2_AndreNavas {
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("\n--- MenÃº ---");
            System.out.println("1. Ingresar informaciÃ³n del libro a la biblioteca");
            ...
            scanner.nextLine();  // Consumir la nueva lÃ­nea despuÃ©s de leer el nÃºmero
            ...
            switch (opcion) {
                ...
                case 2:
                    ...
                    if (libroPrestamo != LIBRO_NO_ENCONTRADO) {
                        ...
                        System.out.println("El libro no está en la biblioteca o la información no coincide.");
                    }
                    break;
                case 3:
                    System.out.print("Ingrese el nombre del libro: ");
